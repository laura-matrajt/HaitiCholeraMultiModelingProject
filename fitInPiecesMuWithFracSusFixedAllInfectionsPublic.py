...
from choleraEqs import choleraEqs11WithoutVaccinationNetwork
...
#may 29th, 2019, I will modify this script so that it computes the total number of infections and not only cases.
...
def simulateUpTo2016FullPop3params(params, extraParams):
    ...
    sol, info = odeint(choleraEqs11WithoutVaccinationNetwork, initCond, tspan,
...
if __name__ == "__main__":
    ...
    results1 = [index, p2, params0, myseed, leastSquaresMuWithFracSusFixed(p2, fullData2017on, extraParamsEndemic_MuFracSusFixed)]
    ...
    filename0 = 'leastSquaresDataUpto2019/'  + 'fitEndemicMuWithFracSusFixed' + '/' +  'fitEndemicMuWithFracSusFixed' + '_'\
